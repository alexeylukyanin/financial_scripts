...
class BacktestEngine:
    ...
    def option_expired(self):
        ...
        # exp = datetime.datetime.strptime(, '%m/%d/%Y %H:%M')
    ...
    def get_expiration_week(self, option_data: np.ndarray) -> np.ndarray:
        ...
        for row in option_data:
            ...
            days_to_sunday_0 = datetime.timedelta(days=(6 - current_week))
            days_to_sunday_1 = datetime.timedelta(days=(13 - current_week))
            days_to_sunday_2 = datetime.timedelta(days=(20 - current_week))

            sunday_0 = current_date + days_to_sunday_0
            sunday_1 = current_date + days_to_sunday_1
            sunday_2 = current_date + days_to_sunday_2
            monday_0 = sunday_0 - datetime.timedelta(days=7)
            monday_1 = sunday_1 - datetime.timedelta(days=7)
            monday_2 = sunday_2 - datetime.timedelta(days=7)

            if monday_0 <= expiration_date < sunday_0:
                expiration_week.append(0)
            elif monday_1 <= expiration_date < sunday_1:
                expiration_week.append(1)
            elif monday_2 <= expiration_date < sunday_2:
                expiration_week.append(2)
            else:
                expiration_week.append(None)
